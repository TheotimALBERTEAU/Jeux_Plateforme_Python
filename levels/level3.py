...
class Level3(LevelSource):
    def __init__(self, game):
        ...
        self.cat_x_startspawn = [649, 749, 932, 1159, 1396]
        self.cat_x_firstspawn = [1537, 1684, 1793, 1873, 1981]
        ...
        self.bob_x_startspawn = [600, 1093, 1482, 1789]
        self.bob_x_firstspawn = [1279, 1537, 1793, 1981]
