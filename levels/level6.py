...
class Level6(LevelSource):
    def __init__(self, game):
        ...
        self.cat_x_startspawn = [625, 767, 814, 967, 1125, 1289, 1357,1457]
        self.cat_x_firstspawn = [1267, 1325, 1490, 1598, 1626, 1793, 1898, 1981]
        ...
        self.bob_x_startspawn = [425, 600, 802, 1079, 1402, 1689, 1887]
        self.bob_x_firstspawn = [725, 942, 1125, 1325, 1537, 1736, 1925]
