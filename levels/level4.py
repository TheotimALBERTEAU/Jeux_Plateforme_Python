...
class Level4(LevelSource):
    def __init__(self, game):
        ...
        self.cat_x_startspawn = [649, 767, 890, 967, 1159, 1357]
        self.cat_x_firstspawn = [1490, 1537, 1684, 1793, 1873, 1981]
        ...
        self.bob_x_startspawn = [600, 808, 1079, 1453, 1789]
        self.bob_x_firstspawn = [1185, 1307, 1537, 1764, 1996]
