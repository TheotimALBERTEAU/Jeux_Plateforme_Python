...
class Animation:
    ...
    def animation_rainbow_skin(self):
        if self.game.pressed.get(pygame.K_d):
            self.game.spawnplayer.player.image = pygame.image.load('assets/animations/rainbow_skin/capy_walk_right_1.jpg')
            self.game.spawnplayer.player.image = pygame.transform.scale(self.game.spawnplayer.player.image, (80, 48))
            """
            self.game.walkcount += 1
            if self.game.walkcount >= 20:
            ...
            self.game.spawnplayer.player.image = pygame.image.load('assets/animations/rainbow_skin/capy_walk_left_1.jpg')
            self.game.spawnplayer.player.image = pygame.transform.scale(self.game.spawnplayer.player.image, (80, 48))
            """
            self.game.walkcount += 1
            if self.game.walkcount >= 20:
